        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://facebook.com/gurleenrajput.in"
                target="_blank"
              ...
              <a
                href="https://instagram.com/gurleen_rajput_official"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
              ...
              <a
                href="https://x.com/gurleenrajput"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
              ...
              <a
                href="https://github.com/gurleenrajput"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
                aria-label="GitHub"
              ...
              <a
                href="https://buymeacoffee.com/gurleenrajput"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
